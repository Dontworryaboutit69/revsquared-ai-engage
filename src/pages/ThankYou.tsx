      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <Card className="bg-[#20215A]/50 border-[#00E5D6]/30 backdrop-blur-sm">
          <CardContent className="p-8 sm:p-12">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-[#00E5D6]" style={{
              fontFamily: 'Audiowide, sans-serif'
            }}>
              Thank You!
            </h1>

            <p className="text-lg sm:text-xl text-[#D3D4FF] mb-8" style={{
            ...
            <div className="bg-[#0D0D0D]/50 rounded-xl p-6 mb-8 border border-[#E536C1]/30">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[#E536C1] mb-3" style={{
                fontFamily: 'Audiowide, sans-serif'
              }}>
                Our AI Agent Will Call You Shortly
              </h3>
              <p className="text-[#D3D4FF] text-sm sm:text-base" style={{
                fontFamily: 'Manrope, sans-serif'
              }}>
                Expect a call within the next 5 minutes to demonstrate our AI capabilities. 
                Make sure your phone is nearby and ready to answer!
              </p>
            </div>

            <div className="space-y-4 text-left text-[#D3D4FF] text-sm sm:text-base mb-8" style={{
              fontFamily: 'Manrope, sans-serif'
            }}>
