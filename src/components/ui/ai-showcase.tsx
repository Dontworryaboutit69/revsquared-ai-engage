      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          >
              ...
              {showcaseItems.map((item, index) => {
                ...
                return (
                  <CarouselItem key={item.id} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/3">
                    <div className="p-1">
                      <Card className="bg-[#20215A]/30 border-[#00E5D6]/30 backdrop-blur-sm hover:border-[#00E5D6]/50 transition-all duration-300 overflow-hidden group h-full">
                        <CardContent className="p-6 flex flex-col h-full">
                          ...
                          {isPlaying && (
                            <motion.div
                              className="flex items-center gap-2 text-[#E536C1] text-xs"
            ...
            <CarouselPrevious className="border-[#00E5D6]/30 text-[#00E5D6] hover:bg-[#00E5D6]/20 -left-12" />
            <CarouselNext className="border-[#00E5D6]/30 text-[#00E5D6] hover:bg-[#00E5D6]/20 -right-12" />
          </Carousel>
        </motion.div>
