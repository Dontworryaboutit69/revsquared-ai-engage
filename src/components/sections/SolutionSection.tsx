...
export function SolutionSection({ onBookDemo, onTryAI }: SolutionSectionProps) {
  return (
    <section className="py-12 sm:py-16 md:py-20 px-4 relative">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        <div className="text-center">
          <p className="text-lg sm:text-xl text-[#D3D4FF] mb-4 sm:mb-6 px-4" style={{ fontFamily: 'Manrope, sans-serif' }}>
            Ready to see it in action?
          </p>
          <div className="flex flex-col sm:grid sm:grid-cols-2 gap-3 sm:gap-4 max-w-2xl mx-auto px-4">
            <Button
              size="lg"
              className="bg-[#00E5D6] text-[#0D0D0D] hover:bg-[#00E5D6]/90 font-bold py-2.5 sm:py-3 px-4 sm:px-6 text-sm sm:text-base w-full"
            ...
            <Button
              size="lg"
              className="bg-[#E536C1] text-[#0D0D0D] hover:bg-[#E536C1]/90 font-bold py-2.5 sm:py-3 px-4 sm:px-6 text-sm sm:text-base w-full"
              style={{ fontFamily: 'Audiowide, sans-serif' }}
              onClick={onTryAI}
            >
